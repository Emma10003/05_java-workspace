...
public class CustomExceptionService {
    ...
    public void problem1() {
        ...
        try {
            ...
            if(height <= 0) {
                throw new NegativeNumberException("키는 0cm보다 커야 합니다.");
            }
    ...
    public void problem2() {
        ...
        try {
            ...
            if(password.length() < 6) {
                throw new TooShortPasswordException("비밀번호는 6자 이상이어야 합니다.");
            }
    ...
    public void problem4() {
        ...
        try {
            ...
            if(name.trim().isEmpty()) {
                ...
                // () 안에 메세지를 파라미터로 넘기지 않아도 실행하면 출력됨
                // => EmptyNameException 클래스의 기본생성자 내부에 이미 메세지가 작성되어 있기 때문!
            }
