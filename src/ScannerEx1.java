...
public class ScannerEx1 {
    public static void main(String[] args) {
        ...
        *
        * 외부 라이브러리 > 자바 버전 폴더 > java.base > util 폴더 내에 존재
        *
        ...
        * */
        ...
        // * System.in : 인텔리제이 실행창이나 CLI(cmd = 명령 프롬프트) 창에서 키보드로 입력
        ...
        String word2 = sc.next(); // 공백의 엔터가 남아있어 다음 문장 입력에 공백이 입력됨.
        ...
        * but 자바에서는 각 변수마다 메모리 할당량을 측정하기 위해서
        *     변수이름 내부에 넣어줄 값의 종류가 무엇인지를 결정해주고,
        *     종류에 해당하는 값만 작성을 해야 함.
        *     그렇지 않으면 Mismatch 와 같은 Exception(예외 상황)이 발생했다는 알림이 발생.
        * */

        System.out.print("문장 입력 : ");
        String str = sc.nextLine();

        // 컴퓨터에서 num1 이라는 변수이름 내에는 사용자가 작성한 숫자값이 들어있음

        // 자바에서는 print 로 시작하는 명칭 내에는 + 를 이용해서 출력 구문 작성.
        //           printf 만 예외적으로 콤마(,)를 사용할 수 있음!!!
