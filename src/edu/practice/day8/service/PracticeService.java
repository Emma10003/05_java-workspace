...
import edu.practice.day8.model.messenger.*;
import edu.practice.day8.model.onlineShopping.*;
import edu.practice.day8.model.socialMedia.*;
import edu.practice.day8.model.streamingService.*;
import edu.practice.day8.model.videoPlayer.*;

public class PracticeService {

    public void videoPlayer() {
        System.out.println("\n=== VideoPlayer ===");
        // 자식 객체 생성 시 공통된 인터페이스로 앞에 작성
