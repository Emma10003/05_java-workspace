...
// ------------------------------------------------------------------------------------------
     ...
     * @return
     */
    public static int 배송비계산(int finalAmount){
    ...
    public static int discountRate(int totalAmount){
        ...
        if (totalAmount >= 1000000) { // 10% 할인
            discountRate = 0.1;
            discountAmount = (int)(totalAmount * discountRate);
            return discountAmount;
        } else if (totalAmount >= 500000) { // 5% 할인
            discountRate = 0.05;
            discountAmount = (int)(totalAmount * discountRate);
            return discountAmount;
        }
