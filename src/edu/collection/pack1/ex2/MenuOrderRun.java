...
public class MenuOrderRun {
     ...
     *
     * 요구사항:
     * 1. 메뉴판 리스트를 만들고 ["빅맥", "상하이버거", "치킨버거", "새우버거", "불고기버거"] 추가 => 직접 타이핑
     * 2. 주문 리스트를 만들어서 고객이 주문한 메뉴들을 저장 => Scanner 이용해서 키보드 자판 전달받아 저장
        ...
        while(true) {
            ...
            switch(choice) {
                ...
                case 2:
                    ...
                    String orderMenu = sc.nextLine(); // orderMenu : 사용자가 작성한 키보드 자판 데이터를 저장하고 있는 공간
                ...
                case 4:
                    ...
                    if(orderList.contains(cancelMenu)) {
                        ...
                        System.out.println("주문하지 않는 메뉴입니다!");
                    }
                    break;
